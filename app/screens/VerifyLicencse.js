  ...
  const handleUpdateProfileMedia = async (data) => {
    ...
    if (verifyResult.data) {
      await authApi.updateProfile({
        driversLicenseVerificationStatus: "success",
        driversLicenseNum,
      });
  ...
  return (
    <View style={styles.container}>
      <AppTextInput
        ...
        returnKeyType='done'
        defaultValue={user.driversLicenseNum}
        onChangeText={(text) => setDriversLicenseNum(text)}
      />
      <AppTextInput
